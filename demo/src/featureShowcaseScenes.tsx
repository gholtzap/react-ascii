...
export function AdaptiveOverlayShowcase() {
  return (
    <div className="feature-demo">
...
export function FormWorkflowShowcase({ mode }: { mode: ShowcaseMode }) {
...
export function TerminalShowcase({ mode }: { mode: ShowcaseMode }) {
...
export function LogViewerShowcase({ mode }: { mode: ShowcaseMode }) {
  const logs = useMemo(
    () => [
...
export function CommandWorkbenchShowcase({ mode }: { mode: ShowcaseMode }) {
...
export function DataTableShowcase({ mode }: { mode: ShowcaseMode }) {
  return (
    <div className="feature-demo">
      <AsciiDataTable
        columns={[
...
export function DiffShowcase({ mode }: { mode: ShowcaseMode }) {
  return (
    <AsciiDiff
      title="Config Diff"
      width={mode === "dashboard" ? 58 : 72}
...
export function ProcessTableShowcase({ mode }: { mode: ShowcaseMode }) {
  return (
    <AsciiProcessTable
...
export function InspectorGridShowcase({ mode }: { mode: ShowcaseMode }) {
  return (
    <div className="feature-demo">
      <AsciiInspector
...
export function TraceTopologyShowcase({ mode }: { mode: ShowcaseMode }) {
  return (
    <div className="feature-demo">
      <AsciiTraceTimeline
...
export function SequenceRackShowcase({ mode }: { mode: ShowcaseMode }) {
  return (
    <div className="feature-demo">
      <AsciiSequenceDiagram
...
export function RuntimePlanShowcase({ mode }: { mode: ShowcaseMode }) {
  return (
    <div className="feature-demo">
      <AsciiFlameGraph
        title="CPU Flame"
...
export function ThemingShowcase({ mode }: { mode: ShowcaseMode }) {
